...
4. Choose **Showdown** or **Classic**, set the number of lineups, and review **Build Strategy**. Normal NFL Classic styles automatically omit deep backups; use Randomized with SIM Edge off only when you want the broad player pool. NFL Classic users can turn on **NFL SIM Edge**, choose **Single Entry**, **3-Max**, **20-Max**, or **150-Max**, and leave **Build depth** on Fast or choose Deep for an up-to-five-minute search.
...
8. Upload the exported file to DraftKings and perform a final check for late scratches, locks, and contest rules.
