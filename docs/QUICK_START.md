...
7. Reopen **Slate Readiness** to review salary and contest-preset fit. Select a finding and choose **Show Players** to focus the player table. Open **Portfolio Insights** to review grades, candidate sources, construction, duplication risk, and scenario coverage. For a performance snapshot, choose **Settings > Copy Last Build Report**; **Build History…** keeps the 25 most recent reports locally and can compare two runs. Then save the lineups you want and choose **Export CSV**.
