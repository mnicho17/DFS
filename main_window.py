...
class MainWindow(SnapshotActions, QtWidgets.QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        inspector_layout.setSizeConstraint(QtWidgets.QLayout.SetMinimumSize)
        ...
        status_grid.setContentsMargins(10, 14, 10, 10)

        status_grid.setSpacing(6)
        status_grid.setSizeConstraint(QtWidgets.QLayout.SetMinimumSize)
        ...
        exposure_grid.setContentsMargins(10, 14, 10, 10)

        exposure_grid.setSpacing(6)
        exposure_grid.setSizeConstraint(QtWidgets.QLayout.SetMinimumSize)
        exposure_grid.setColumnStretch(0, 1)
        exposure_grid.setColumnStretch(1, 1)

        exposure_grid.addWidget(btn_max_exposure, 0, 1)

        exposure_grid.addWidget(btn_min_exposure, 0, 0)

        exposure_grid.addWidget(btn_max_cpt, 1, 1)

        exposure_grid.addWidget(btn_min_cpt, 1, 0)

        exposure_grid.addWidget(btn_clear_max, 2, 1)

        exposure_grid.addWidget(btn_clear_min, 2, 0)
        ...
        btn_max_exposure.setText("Max %")

        btn_min_exposure.setText("Min %")

        btn_max_cpt.setText("Captain max %")

        btn_min_cpt.setText("Captain min %")

        btn_clear_max.setText("Clear max")

        btn_clear_min.setText("Clear min")

        btn_copy_own_to_max.setText("Use ownership as max")
        ...
        team_layout.setContentsMargins(10, 14, 10, 10)
        ...
        team_layout.setSizeConstraint(QtWidgets.QLayout.SetMinimumSize)
        ...
        btn_cpt_lock.setText("Lock Captain")
        btn_cpt_fade.setText("Fade Captain")
        btn_clear.setText("Clear lineup tags")
        self.player_inspector.setMinimumWidth(260)
